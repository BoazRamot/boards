...
export const autocompleteInit = (map: any, autocompleteBoxRef: any, maps: any, marker: any, handleAutocompleteInputDialogOpen: any, updateLocation: any, setAutocompleteInput: any, getBoards: any) => {
  ...
  const placeListener = (autocompleteInput as any).addListener('place_changed', () => {
    ...
    if (location) {
      newMarker = addMarker({name, location}, map, maps);
    }
